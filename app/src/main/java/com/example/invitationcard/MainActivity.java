...
/***********************************************
 Author: Raul Vargas
 Date: 9/17/2022
 Purpose: The purpose of this assignment was to create an invitation
 screen and use the concept that we learned in class like margins
 and padding in order to create a nice looking party invitation.
 What Learned: I think I learned how to navigate the text properties
 for the textviews and imageviews.
